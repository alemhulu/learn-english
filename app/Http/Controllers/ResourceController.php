...
class ResourceController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($resources as $key => $resource) {
            ...
            if ($type == "Text Books") {
                ...
                //for grade 1-4
                elseif ($resource->grade->name=="1"||$resource->grade->name=="2"||$resource->grade->name=="3"||$resource->grade->name=="4") {
                    ...
                    $resource->description=$desc;
                    $resource->save();
                } elseif ($resource->grade->name=="5"||$resource->grade->name=="6"||$resource->grade->name=="7"||$resource->grade->name=="8") {
    ...
    public function store(Request $request)
    {
        if ($request->fileLocation!="" & $request->folderLocation=="") {
            ...
            $this->upload($request);
        } elseif ($request->fileLocation=="" & $request->folderLocation!="") {
            $this->validate($request, [
                'course_id'=> 'required',
                    'link'=> 'required',
                     'media_id'=> 'required',
