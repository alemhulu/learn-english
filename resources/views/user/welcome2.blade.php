                ...
                @if(count($grades)>0) 
                  <ul style="color:black;">
                    ...
                    @foreach($grades as $grade)
                      <li><input type="radio"class="form-check-input gradeRadio" name="grade" value="{{$grade->id}}" id="gradeId" onchange="gredeFilter()" ><h6 class="">
				@if($grade->name==0)
				   Pre Primary
				@else
				   Grade - {{$grade->name}}
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3" id="linkColor">
                          <div class="shadow-sm bg-white zoom" data-toggle="tooltip" data-placement="top" title="{{$resource->description}}"
                            ...
                            <div class="p-1 shadow rounded text-black ">
                              @if($resource->media->name == "Document"||$resource->media->name == "document" || $resource->unit_id =="")
